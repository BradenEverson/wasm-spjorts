...
export interface InitOutput {
  ...
  readonly closure943_externref_shim: (a: number, b: number, c: any) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h54d76743741ae7bf: (a: number, b: number) => void;
  readonly closure945_externref_shim: (a: number, b: number, c: any, d: any) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hd41bec28ed72cfd7: (a: number, b: number) => void;
  readonly closure70406_externref_shim: (a: number, b: number, c: any) => void;
